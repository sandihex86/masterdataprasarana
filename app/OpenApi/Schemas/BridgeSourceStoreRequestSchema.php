...
#[OA\Schema(
    schema: 'BridgeSourceStoreRequest',
    required: ['active', 'status', 'statusdata'],
    properties: [
        new OA\Property(property: 'uniqid', type: 'string', nullable: true, example: '6498347da7db7'),
        ...
        new OA\Property(property: 'foto1', type: 'string', nullable: true, example: 'jembatan11687696509.jpg'),
        new OA\Property(property: 'caption1', type: 'string', nullable: true, example: null),
        ...
        new OA\Property(property: 'statusdata', type: 'integer', example: 0),
...
final class BridgeSourceStoreRequestSchema
{
}
